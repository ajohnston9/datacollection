 ...
 */
public class GyroscopeRecordSerializer implements JsonSerializer<GyroscopeRecord> {
    private JsonArray array = new JsonArray();

    public JsonElement serialize(GyroscopeRecord src, Type typeOfSrc, JsonSerializationContext context) {
